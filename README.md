...
# User interface
When the user submits the URL of location they want to view, the data is download from the reviews (top 5 reviews for google) and user can export as a CSV file by clicking the export button.
